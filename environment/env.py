...
class PMSP:
    def __init__(self, num_job=200, num_m=5, episode=1, test_sample=None, reward_weight=None, ddt=None, pt_var=None,
                 is_train=True):
    ...
    def _modeling(self):
        ...
        rule_weight = {"ATCS": [3.5, 1.4], "COVERT": 7.6}
        routing = Routing(env, model, monitor, end_num=self.num_job, weight=rule_weight)
        routing.reset()
